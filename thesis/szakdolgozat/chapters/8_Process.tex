...
A következő az igénylő szervezeti egység, amely egy felugró kereső ablak, ahol a felhasználó
kiválasztja azt, hogy melyik szervezethez tartozik.

Ennek adatai egy külön adatbázis táblában kapnak helyet, amelyben a cégnél nyilvántartott szervezetek lesznek eltárolva,
...
Ekkor megjelenik egy új kiválasztós mező, amelyben az \textit{Oda út és vissza út}ról kérdez, illetve négy
további mező, amely a gépjármű elvitelének és a gépjármű leadásának az ideje, illetve a gépjármű
...
Lehetőségünk van több utast is hozzáadni, amelyben a hozzáadás gombra kattintva felugrik egy rész,
ahol az adatokat kérjük le.
Ez szintén egy új táblázat lesz (Road Transportation Demand DTL), amelyből egy folyamathoz, akár több
is tartozhat.
...
annyi eltéréssel, hogy az utasnak nem lesz költséghelyi kódja.
...
milyen adatokkal szeretnének járművet bérelni.

Mivel ez egy egyszerű, kétlépéses folyamat, egy Draft és egy Approve lépésből állt, a folyamat ezt
...
Az első lépést, azaz a \textit{draft}-ot itt láthatjuk \aref{fig:maintranceDraft}. ábrán.
...
további adatokat is. A keresés gomra kattintva, automatikusan kitöltődnek a csak olvasható (\textit{read only}) mezők
