        ...
        return(
                  ...
                  <Col sm={12}>
                      <Form onSubmit={this.handleSubmit}>
                          <Form.Group controlId="DepartmentName">
                              ...
                              <Form.Control type="textarea" name="DepartmentName" required placeholder="Adja meg a felügyelő pontos leírását"  disabled />
           ...
           <Table className="mt-4" striped bordered hover size="sm" >
               ...
               <tbody>
                   ...
                   <td>
                       <ButtonToolbar>
                           <Button className="mr-2" variant="info" onClick={()=>this.setState({editModalShow:true,depid:dep.MechanicalID,depname:dep.MechanicalName})} > 
                               Edit
                           </Button>

                           <Button className="mr-2" onClick={()=>this.deleteDep(dep.MechanicalID)}  variant="danger" >Delete
                           </Button>
...
<ButtonToolbar>
<Button variant="primary" onClick={()=>this.setState({addModalShow:true})}>Add Mechanical</Button> 
