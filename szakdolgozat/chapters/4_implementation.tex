...
A korábbi workflow rendszerek csak az üzleti folyamatok leképezését tették lehetővé vizualizációs eszközök segítségével. A BPM azóta sokat fejlődött és a támogató szoftvercsomagok sokkal több lehetőséget nyújtanak már.
...
% TODO: Hogy ha a modellről ilyen formában szó esik, akkor azt érdemes korábban megtenni.
...
% TODO: A nemdeterminisztikus modelleknek milyen jelentősége lesz a későbbiekben? (Nem teljesen tünne indokoltnak ilyen formában a témához.)
...
fejlesztéséhez, integrációjához, tervezéséhez és rendszerelemzéshez kapcsolódó tevékenységek leírására használják [].
...
folyamatmotoron át a modellező eszközig [].
