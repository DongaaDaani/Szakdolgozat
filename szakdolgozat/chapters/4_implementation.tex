...
Egy vállalat élete során rengeteg problémával néz szembe, akár napi szinten. Ez lehetnek egyszerű, vagy teljesen komplex feladatok is. Ahhoz, hogy egy vállalat zökkenő mentesen működjön, fontos ezeket a feladatokat könnyedén, hatékonyan megoldani.
...
Ezek a következő szakaszokban kerülnek kifejtésre.
\cite{Bene}
\Section{Elvárások}
...
A folyamatgráf (\textit{Process Graph}, \textit{P-Graph}) egyik nagy előnye a folyamatok gráf alapú szemléltetésének, hogy a gráfelmélet eredmények és algoritmusok alkalmazhatóak  a vizsgálat során. \\
...
szereplőinek, hogy folyamataikat standardizált formában tehessék közzé. \cite{Bohacs}
...
A BPMN üzleti folyamat modellező szabvánnyá vált. Népszerűségét könnyű elsajátíthatóságának és értelmezhetőségének köszönheti.
...
A BPEL olyan szabványos leíró nyelv, amely üzleti partnerek folyamatainak leírásara
...
külső, kiegészítő nyelven elkészített parancs meghívásával jár, ami leggyakrabban Java. \cite{BMEIK} \\
