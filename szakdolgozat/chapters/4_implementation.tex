...
Egy vállalat élete során rengeteg problémával néz szembe, akár napi szinten. Ezek lehetnek egyszerű, vagy teljesen komplex feladatok is. Ahhoz, hogy egy vállalat zökkenő mentesen működjön, fontos ezeket a feladatokat könnyedén, hatékonyan megoldani.
...
Ilyenek lehetnek a Process Designerbe integrált plusz funkciók, mint a folyamatokhoz tartozó folyamatábra, a folyamat lépéseihez tartozó űrlapok megtekintése, és az, hogy az egyes mezők mögött milyen metódus hívások , és adatbázis van. Az összes üzleti folyamatot egy helyen lehet tárolni. 
\cite{Bene}

\Section{Elvárások}
Egy folyamat modellezőnek a következő képességekkel kell rendelkezniük:
\begin{itemize}
\item Mérések: Lehetőséget ad arra, hogy a folyamatokat valós időben átláthassuk.
...
\item Analízis: Elemzések, jelentések.\cite{Bene}
\end{itemize}
...
Az első két ábrán \ref{fig:Demand_Process} \ref{fig:maintane_process} látható folyamatábra nem determinisztikus volt, mivel mindkettőnél két bemenet volt, az egyik a Draft, a másik pedig a Start lépést. A start lépést a Draft lépés követi.

A legtöbb korszerű workflow rendszer főbb szolgáltatásai alkalmasak a munkafolyamatok között eltelt idő, várakozási és sorbaállási idők csökkentésére, és minimalizálására. A sorbaállási modell nem elhanyagolható, mivel gyakran felhasználják üzleti döntéseknél, ahol az erőforrások becslése nem elhanyagolható. \cite{sorbanallaswikipedia} Könnyen előfordulhat ugyanis nagyobb mértékű feltolódás egy bizonyos erőforráson, amely nagy kapacitást igényel. A sorbanállási modell a hétköznapi életben is előforduló egyik kellemetlen jelenség a
...
kiszolgálásra, és ezek összefüggéseit tárgyalja az alkalmazott matematikai eszközeivel. \cite{Sorba} \\ 

A folyamat során várakozó sor keletkezhet, ha a kiszolgáló egységekbe történő áramlás
időköze, és a kiszolgálás időtartama szabálytalan. Sorbaállás keletkezhet akkor is, a
...
Az Integrated Definition (IDEF) folyamatleíró nyelvet elsősorban folyamatok
...
\item  \textbf{IDEF0}  Funkció modellezés 
...
\item \textbf{IDEF4}  : Objektum-orientált tervezés - Az objektumorientált programozás, karbantarthatóság és kód újrafelhasználhatóság megvalósítható a hagyományos adatfeldolgozó alkalmazásokban.  \cite{Bene} \\
\end{itemize}

\SubSection{Event Driven Process Chain}
Előfordulhat, hogy ugyanazt az üzleti folyamatot egyszerre több ember vagy gép végzik. Akár több független igénylés is érkezhet, ami több összetett lépésből áll. Ez lehet több egyszerre történő módosítás egy nagy gyárban, stb. Ilyenkor meg kell különböztetni ezeknek a folyamatokat, párhuzamosan kell tudni kezelni.
Erre szolgál az EPC, vagy az Event Driven Process Chain, amely az események és funkciók irányított gráfja.
...
és a XOR. \\
XOR, vagy más néven kizáró vagy az alábbi formátummal adható meg : $ ( \bar{x} \land y  ) \lor ( x \land \bar{y} )$ \\
...
A YAWL (Yet Another Workflow Language) Kezdetben csupán a munkafolyamatokban előforduló tevékenységekre koncentrált, de mára
már munkafolyamat leírásának teljes eszköztárát támogatja a folyamateditortól a
folyamatmotoron át a modellező eszközig \cite{Bohacs}.
...
Az XPDL (XML Process Definition Language) a WfMC (Wokflow Management Coalition)
