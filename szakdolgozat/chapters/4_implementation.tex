...
Két fő célja van :
Első,  hogy az XML alapú nyelvek, amiket az üzleti folyamatok végrehajtására terveznek, azok vizualizálhatók legyenek egy szabványos jelölőrendszerrel. \cite{Bene} \\
...
Az első két ábrán látható folyamatábra nem determinisztikus volt, mivel mindkettőnél két bemenet volt, az egyik a Draft, a másik pedig a Start lépést. A start lépést a Draft lépés követi.
