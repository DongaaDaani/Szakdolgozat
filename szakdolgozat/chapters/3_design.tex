...
\begin{itemize}
	...
	\item a téglalap-alakú állapotátmeneteket (transitions).
\end{itemize}
...
Jelölje $m_{0}$ a kezdeti token eloszlást, az-az ez a hálózat kezdeti állapota.
...
A Petri hálókat az alábbi rendszerek modellezésében szokták alkalmazni: nemdeterminisztikus, párhuzamos, elosztott, konkurens, asszinkron.
...
Előnye az autómatákhoz képest,
% TODO: Ez is egy automata. Itt melyikkel történik a szembeállítás?
...
% TODO: Hogyan kapcsolódik az előzőekhez a feszítőfa?
...
% TODO: Ez a rész még itt elég zavaros.
