...
Tehát két típusú csomópontja lehet, egy kör és egy téglalap. A kör esetén egy hely, téglalap esetén egy trazíció.

Van egy állapotjelölő token, amely fekete pötty a hely körébe rajzolva.
A hely állapota a benne lévő tokenek száma.\\
Egy hely engedélyezett, ha minden input helyén van legalább egy token.
