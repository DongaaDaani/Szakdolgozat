...
mutatom be, illetve mindegyikhez adunk egy-egy rövid leírást az adott felhasználói felület funkcióiról.
...
Ugyanezen a formon lehetőségünk van egy részleg hozzáadására, az \textit{Id} automatikusan incrementálódik, tehát a felhasználónak csak magát a részleg
nevét kell megadnia.
...
POST / DELETE / UPDATE / DELETE metódust szeretnék végrehajtani az adott URL-en.
...
Itt egy adat kerül hozzáadásra, az \textit{Alkalmazottak} mezőhöz. A POST methodusnál
...
Telefon, vagy egyéb kisebb eszközön az űrlap \aref{fig:responsive}. ábrán látható formában kerül megjelenítésre. 
