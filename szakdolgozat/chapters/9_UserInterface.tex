...
\begin{thebibliography}{9}
	\bibitem{Petri} 
	Dr. Bartha Tamás , Dr. Pataricza András, Dr. Majzik István ,
	...
	\bibitem{Bohacs} 
	 Dr. Bohács Gábor,
	 \textit{Folyamatmodellezés és szimuláció }
	 
	 \bibitem{Bene} 
	Bene Katalin,
	 \textit{Üzleti folyamatok modellezése }
	 
	  \bibitem{BMEIK} 
	BME IK,
	 \textit{Folyamatleíró nyelv kiválasztása }
	 
	 \bibitem{wikipedia}
	 Wikipedia,
	 \textit{ Petri Hálók
	 %	\url{https://hu.wikipedia.org/wiki/Petri-h%C3%A1l%C3%B3?fbclid=IwAR1x_wnNUA_4iiG_IWPTDcrUMtUq5QPChOFbWl3JQBJDoHe8hLktuzvoVTs} 
  }

  \bibitem{BPMN} 
Microsoft Team,
\textit{Útmutató kezdőknek a BPMN alkalmazásához a mindennapi üzleti életben }

  \bibitem{Corvin} 
Budapesti Corvinus Egyetem,
\textit{A szemantikus folyamatmenedzsment hasznosítási lehetősége az üzleti folyamatok tudásalapú fejlesztésében}

  \bibitem{Szeged} 
Szegedi Tudományegyetem,
\textit{Formális Módszerek}

 \bibitem{Sorba} 
Dr. Sztrik János,
\textit{A sorbanállási elmélet alapjai}
