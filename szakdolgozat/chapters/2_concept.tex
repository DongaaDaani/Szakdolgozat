...
matematikai jelölések és modellek állnak rendelkezésre.
\Section{Véges Determinisztikus automaták}

Véges számú állapotból, ésa közöttük lévő átmenetekből (tranzíciókból) áll, amelynek szakaszait úgynevezett input szimbólumok jellemzik, amelyek ugyanabból a véges $\Sigma$ ábécéből vannak kiválasztva. 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=7.8truecm, height=7.8truecm]{images/AllapotAtmenet.png}
