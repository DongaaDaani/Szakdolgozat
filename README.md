# Webalkalmazás készítése üzleti folyamatok optimalizálásához

*BSc szakdolgozat*

A dolgozat célja egy olyan információs rendszer készítése, amely segítségével nyomon követhetők, elemezhetők és így optimalizálhatók vállalatok üzleti folyamatai. Az alkalmazás különböző szerepköröket, jogosultsági szinteket különböztet meg (amellyel például az alkalmazottak és vezetők hozzáférési módja, és elvégezhető műveleteik szabályozhatók).
